...
class Snake(object):
	...
	def draw(self):
		for aLoc in self.loc:
			controller.setPixel(aLoc[0], aLoc[1], self.color[0], self.color[1], self.color[2])
		controller.setPixel(self.food[0], self.food[1], self.fColor[0], self.fColor[1], self.fColor[2])
